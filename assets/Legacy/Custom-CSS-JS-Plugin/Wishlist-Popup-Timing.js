 ...
 * Datum: 2026-01-11
 * Wijziging:
 * - Detecteert TI modal: .tinvwl_added_to_wishlist.tinv-modal
 * - Houdt de modal geforceerd open door .tinv-modal-open vast te houden
 * - Sluit pas na ingestelde duur (LMB_POPUP_MS)
 *
 */

(function () {
  var LMB_POPUP_MS = 10000; // <-- pas dit aan (bijv. 6000 = 6 seconden)
...
/* === Einde La Maison Bossché – Wishlist Popup Timing === */
